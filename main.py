...
parser.add_argument('--EnvIdex', type=int, default=3, help='Humanoid-v4,HalfCheetah-v4, Hopper-v4, HumanoidStandup-v4')
...
def main():
    ...
    agent = GQN_agent(**vars(opt)) # var: transfer argparse to dictionary
            ...
            while not done:
                if total_steps < (10*opt.max_e_steps): 
                    ...
                    with torch.no_grad():
                        ...
                        a = agent.actor(state).cpu().numpy()[0]
